...
import martImg  from './assets/footer_logo.png';

    const  EndFooter = () => {
        return (
              
                     <footer className="py-5 footerlast">
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <img src={martImg} alt="logo" className = "footer-logo-img"/>
                    <div className="social-links mt-5">
                <ul className="d-flex list-unstyled gap-2">
                  <li>
                    <a href="#" className="btn btn-outline-danger">
                      <svg xmlns="http://www.w3.org/2000/svg" style =  {{width:'16', height:"16"}} viewBox="0 0 24 24"><path fill="currentColor" d="M15.12 5.32H17V2.14A26.11 26.11 0 0 0 14.26 2c-2.72 0-4.58 1.66-4.58 4.7v2.62H6.61v3.56h3.07V22h3.68v-9.12h3.06l.46-3.56h-3.52V7.05c0-1.05.28-1.73 1.76-1.73Z"></path></svg>
                    </a>
                  </li>
                  <li>
            ...
            <div className="footer-menu">
              ...
              <ul className="menu-list list-unstyled">
                <li className="menu-item">
                  <a href="#" className="nav-link">Subscribe to our newsletter to get</a>
                </li>
                <li className="menu-item">
                  <a href="#" className="nav-link">updates about our grand offers. </a>
                </li>
