            ...
            if(isset($_POST['submit'])){   
                ...
                if(isset($_GET['dish_id']) == ''){
                    ...
                    if($type == "image/jpeg" || $type == "image/png"){
                        ...
                        echo $sql = " INSERT INTO `or_dish_table`(`category_id`, `dish_name`, `dish_short_details`, `dish_details`, `dish_image`, `dish_status`, `add_on`) VALUES ('$category_id','$dish_name','$short','$dish_details','$filename','$status','$add_on')";
